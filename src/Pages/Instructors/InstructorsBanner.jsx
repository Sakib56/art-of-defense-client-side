...
import img from '../../assets/Instructorbanner.jpg'
        ...
        <div className='pt-14 md:pt-0 grid grid-cols-2 bg-black bg-opacity-30'>
            <div className='items-center flex'>
                <div className='ml-2 lg:ml-20'>
                    <h1 className='text-sm md:text-5xl bg-gradient-to-r from-red-800 to-red-400 font-semibold italic bg-clip-text text-transparent'>Meet our all the talented instructors</h1>
            ...
            <div>
                <img className='w-full h-[200px] md:h-[600px] opacity-50' src={img} alt="" />
            </div>
        </div>
    );
};
