...
import logo from '../../../assets/martial-arts-logo.png'

const Footer = () => {
    return (
        <div className='p-10 md:mt-20 bg-zinc-600 text-white text-lg'>
            <footer className="footer">
                <div>
                    <img className='h-20 w-20 rounded-full' src={logo} alt="" />
                    <p>Art of Defense Academy<br />Providing reliable training since 1992</p>
